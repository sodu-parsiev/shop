    ...
    public function form(Schema $schema): Schema
    {
        return $schema
            ...
            ->components([
                ...
                Section::make('01 · Почему «Свой Ход»')
                    ->schema([
                ...
                Section::make('02 · Каталог и производство')
                    ->schema([
                ...
                Section::make('03 · Для продавцов маркетплейсов')
                    ->schema([
                ...
                Section::make('04 · О производстве')
                    ->schema([
                ...
                Section::make('05 · Печать и кастомизация')
                    ->schema([
                ...
                Section::make('06 · Условия сотрудничества')
                    ->schema([
                ...
                Section::make('FAQ (заголовок блока)')
                    ->schema([
                ...
                Section::make('Личный кабинет (анонс)')
                    ->schema([
                ...
                Section::make('07 · Начать сотрудничество')
                    ->schema([
