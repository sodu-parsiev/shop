...
class CatalogSeeder extends Seeder
{
    ...
    private function productRows(): array
    {
        return [
            ...
            $this->row('kids-tee-175-185', 'SH-KIDS-TEE-180', 'Детская футболка', 'Детская одежда', '180 гр', 'Regular Fit', [10000 => 155, 5000 => 160, 1000 => 165, 500 => 170, 100 => 175, 10 => 180], '/brand/products/kids-tee-175-185.jpg', sizeNames: self::KIDS_SIZES, sizeTable: $this->kidsSizeTable(), colorNames: ['Белый', 'Чёрный']),
            $this->row('longsleeve-140-150', 'SH-LONG-145', 'Лонгслив', 'Лонгсливы', '180 гр', 'Regular Fit', [10000 => 210, 5000 => 215, 1000 => 220, 500 => 225, 100 => 230, 10 => 235], '/brand/products/longsleeve-140-150.jpg', colorNames: ['Белый', 'Чёрный']),
